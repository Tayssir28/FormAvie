...
<body>
    ...
    <div class="login-wrap">
        <div class="login-html">
            <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Sign In Utilisateur</label>
            <div class="login-form">
                <div class="sign-up-htm">
                <form name="f" method="POST" action="{{ route('users.store') }}">
    @csrf
    <div class="group">
